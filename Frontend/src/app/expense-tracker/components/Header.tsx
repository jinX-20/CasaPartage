      ...
      <div className="bg-[#EFD5C5] rounded bg-opacity-45">
        <div className="flex justify-between items-center py-3 px-5">
          <div className="flex items-center">
            <button><img src="/logo.png" alt="Logo" className="w-9 h-auto pr-2 logo inline-block"></img></button>
          ...
          <div>
            <button className="w-14 h-auto"><img src="/profile_icon.jpg" alt="pfp"></img></button>
          </div>
        </div>
      </div>
    </div>
