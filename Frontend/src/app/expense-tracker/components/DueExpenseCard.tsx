...
interface DueExpenseProps {
  ...
  userId: string;
  markAllAsPaid: (expenses: ExpenseDetail[], userId: string) => void;
}

const DueExpenseCard: React.FC<DueExpenseProps> = ({ name, amount, expenses, userId, markAllAsPaid }) => {
  ...
  return (
    <div className="bg-[#EAE3CF] shadow-lg rounded-lg p-4 border border-gray-300">
      ...
      <div className="mt-3 flex space-x-4">
        <button
          onClick={() => markAllAsPaid(expenses, userId)} // Use the function passed from the parent
